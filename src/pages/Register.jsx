...
export default function Register() {
  ...
  // Local server has no mailer: it echoes back the generated code so
  // registration completes without email delivery.
      ...
      >
        ...
        {devOtp && (
          <p className="mb-4 text-center text-xs text-muted-foreground">
            Local mode helper — your verification code is{" "}
