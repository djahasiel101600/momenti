...
// flow after sign-in). Keep the redirect validation in one place — it is
...
// backslash). Bootstrap params from the old hosted-platform era are also
// stripped so a crafted returnTo can never smuggle credentials around.
